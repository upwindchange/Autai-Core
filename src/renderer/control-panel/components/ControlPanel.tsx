            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  {lastInitializationResult && (
                    <div
                      className={`text-sm ${lastInitializationResult.success ? "text-green-600" : "text-red-600"}`}
                    >
            ...
            {lastDragResult && (
              <div className="mt-3 p-3 bg-gray-100 rounded">
                <div className="text-sm">
                  ...
                  <span
                    className={
                      lastDragResult.success ? "text-green-600" : "text-red-600"
                    }
                  >
                ...
                {lastDragResult.sourceCoordinates &&
                  lastDragResult.targetCoordinates && (
                    <div className="text-sm text-gray-600 mt-1">
                      <span className="font-medium">From: </span>(
                      {Math.round(lastDragResult.sourceCoordinates.x)},{" "}
                      {Math.round(lastDragResult.sourceCoordinates.y)})
