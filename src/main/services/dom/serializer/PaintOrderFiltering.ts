 ...
 */
export function splitDiff(a: PaintOrderRect, b: PaintOrderRect): PaintOrderRect[] {
 ...
 */
export function paintOrderContains(r: PaintOrderRect, paintOrderRects: PaintOrderRect[]): boolean {
 ...
 */
export function paintOrderAdd(r: PaintOrderRect, paintOrderRects: PaintOrderRect[]): boolean {
